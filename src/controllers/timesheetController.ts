...
export async function createTimesheetHandler(req:Request, res:Response) {
  try {
...
export async function getTimesheetByIdHandler(req:Request, res:Response) {
  try {
...
export async function updateTimesheetHandler(req:Request, res:Response) {
  try {
    const id = req.params.id;
...
export async function deleteTimesheetHandler(req:Request, res:Response) {
  try {
    const id = req.params.id;
