...
export async function startShiftHandler(req:Request, res:Response) {
  try {
...
export async function endShiftHandler(req:Request, res:Response) {
  try {
    const {employeeId} = req.body;
...
export async function getAllShiftsHandler(req:Request, res:Response) {
  try {
