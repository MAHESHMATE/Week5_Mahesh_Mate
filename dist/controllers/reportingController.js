...
exports.generateReportInExcelHandler = exports.generateReportHandler = void 0;
const reportingService_1 = require("../services/reportingService");
function generateReportHandler(req, res) {
...
function generateReportInExcelHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { startDate, endDate } = req.body;
...
exports.generateReportInExcelHandler = generateReportInExcelHandler;
