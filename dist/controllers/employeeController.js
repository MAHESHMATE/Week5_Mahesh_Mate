...
exports.deleteEmployeeHandler = exports.updateEmployeeHandler = exports.getAllEmployeesHandler = exports.loginEmployeeHandler = exports.registerEmployeeHandler = void 0;
const employeeService_1 = require("../services/employeeService");
function registerEmployeeHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const employeeData = req.body;
            const employee = yield (0, employeeService_1.registerEmployee)(employeeData);
...
exports.registerEmployeeHandler = registerEmployeeHandler;
