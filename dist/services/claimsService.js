...
const claimsModel_1 = require("../models/claimsModel");
function createClaim(claimData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const claim = yield claimsModel_1.Claims.create(claimData);
            return claim;
        }
        catch (error) {
...
function getClaimById(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const claim = yield claimsModel_1.Claims.findByPk(id);
            if (!claim) {
